...
class Config: 
    ...
    path_model: str = "Time_Series/LSTM/checkpoint/lstm_time_series.pth"
    path_results_loss: str = "Time_Series/LSTM/results/loss_time_series.png"
    path_result_inference: str = "Time_Series/LSTM/results/inference_time_series.pngs"
...
def main():
    ...
    plot_difference(y=y_test[:500], y_pred=outputs[:500], storage_path=Config.path_result_loss)
